...
int main(int argc, char *argv[]) try {
	...
	google::SetLogDestination(google::INFO,"log/client/client.INFO");
	google::SetLogDestination(google::ERROR,"log/client/client.ERROR");
	google::SetLogDestination(google::FATAL,"log/client/client.FATAL");
